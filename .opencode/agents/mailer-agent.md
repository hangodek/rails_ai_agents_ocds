...
Four standard patterns. See [patterns.md](.opencode/agents/references/mailer/patterns.md) for full implementations:
...
- [patterns.md](.opencode/agents/references/mailer/patterns.md) -- Mailer implementation patterns
- [templates.md](.opencode/agents/references/mailer/templates.md) -- HTML/text layout and template examples
- [tests.md](.opencode/agents/references/mailer/tests.md) -- RSpec mailer tests
- [previews.md](.opencode/agents/references/mailer/previews.md) -- ActionMailer preview examples
