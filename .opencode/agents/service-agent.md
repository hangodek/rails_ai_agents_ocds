...
See [patterns.md](.opencode/agents/references/service/patterns.md) for full implementations:
...
- [patterns.md](.opencode/agents/references/service/patterns.md) - CRUD, Transaction, Calculation, and Dependency Injection patterns
- [testing.md](.opencode/agents/references/service/testing.md) - RSpec specs for create services, side effects, and transactions
