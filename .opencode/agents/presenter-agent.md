...
See [patterns.md](.opencode/agents/references/presenter/patterns.md) for complete implementations including ApplicationPresenter base class, multiple presenter examples, and view usage.
...
- [patterns.md](.opencode/agents/references/presenter/patterns.md) -- ApplicationPresenter base class, all presenter implementations, and view usage examples
- [testing.md](.opencode/agents/references/presenter/testing.md) -- RSpec specs for entity, user, and order presenters
