...
See [patterns.md](.opencode/agents/references/query/patterns.md) for the ApplicationQuery base class and full implementations (search, reporting, joins, full-text, geolocation, pagination).

## References

- [patterns.md](.opencode/agents/references/query/patterns.md) -- ApplicationQuery base class and 7 query object implementations
- [testing.md](.opencode/agents/references/query/testing.md) -- RSpec specs for query objects including N+1 prevention tests
