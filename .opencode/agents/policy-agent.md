...
See [policy-patterns.md](.opencode/agents/references/policy/policy-patterns.md).
...
```
See [testing-and-controllers.md](.opencode/agents/references/policy/testing-and-controllers.md) for complete examples.
...
## References
- [policy-patterns.md](.opencode/agents/references/policy/policy-patterns.md) -- ApplicationPolicy base + 5 policy patterns
- [testing-and-controllers.md](.opencode/agents/references/policy/testing-and-controllers.md) -- RSpec tests, controller integration, view checks
