...
- [templates.md](.opencode/agents/references/controller/templates.md) -- Controller templates: REST, service objects, nested resources, API, Turbo Streams, error handling, HTTP status codes
- [request-specs.md](.opencode/agents/references/controller/request-specs.md) -- RSpec request specs for HTML and API endpoints
