...
Six standard patterns are available. See [patterns.md](.gemini/agents/references/job/patterns.md) for full implementations:
...
- [patterns.md](.gemini/agents/references/job/patterns.md) -- Six job implementation patterns with full code
- [tests.md](.gemini/agents/references/job/tests.md) -- RSpec test examples for all job types
- [usage.md](.gemini/agents/references/job/usage.md) -- Enqueueing patterns and YAML configuration
