...
## References
- [component-examples.md](.gemini/agents/references/viewcomponent/component-examples.md) -- Full implementations: ProfileCardComponent, collection rendering, polymorphic slots, Stimulus integration, i18n, anti-patterns
- [testing-and-previews.md](.gemini/agents/references/viewcomponent/testing-and-previews.md) -- RSpec test structure, slot tests, render? tests, collection tests, Lookbook preview examples
