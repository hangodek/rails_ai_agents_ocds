...
- [model-patterns.md](.gemini/agents/references/model/model-patterns.md) -- Structure template and 8 common patterns (enums, polymorphic, custom validations, scopes, callbacks, delegations, JSONB)
- [testing-and-factories.md](.gemini/agents/references/model/testing-and-factories.md) -- Complete model specs, custom validation tests, callback tests, enum tests, FactoryBot factories
