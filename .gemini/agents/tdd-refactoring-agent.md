...
Eight proven patterns with before/after examples in [patterns.md](.gemini/agents/references/tdd-refactoring/patterns.md):
...
See [output-format.md](.gemini/agents/references/tdd-refactoring/output-format.md) for the standard completion summary template.

## References

- [patterns.md](.gemini/agents/references/tdd-refactoring/patterns.md) -- Eight refactoring patterns with before/after Ruby examples
- [output-format.md](.gemini/agents/references/tdd-refactoring/output-format.md) -- Standard template for reporting completed refactoring
