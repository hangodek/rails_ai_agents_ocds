...
See [policy-patterns.md](.gemini/agents/references/policy/policy-patterns.md).
...
```
See [testing-and-controllers.md](.gemini/agents/references/policy/testing-and-controllers.md) for complete examples.
...
## References
- [policy-patterns.md](.gemini/agents/references/policy/policy-patterns.md) -- ApplicationPolicy base + 5 policy patterns
- [testing-and-controllers.md](.gemini/agents/references/policy/testing-and-controllers.md) -- RSpec tests, controller integration, view checks
