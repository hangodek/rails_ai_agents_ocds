...
## Form Patterns
See [form-patterns.md](.gemini/agents/references/form/form-patterns.md) for full implementations:
...
## Testing
See [testing-and-views.md](.gemini/agents/references/form/testing-and-views.md) for complete specs and view examples.
...
Controllers use `#save` / re-render; views use `form_with model: @form`. See [testing-and-views.md](.gemini/agents/references/form/testing-and-views.md).
...
## References
- [form-patterns.md](.gemini/agents/references/form/form-patterns.md) -- ApplicationForm base class and 4 patterns
- [testing-and-views.md](.gemini/agents/references/form/testing-and-views.md) -- RSpec specs, controller usage, ERB views with Stimulus
