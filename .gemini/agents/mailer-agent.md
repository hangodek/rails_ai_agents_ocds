...
Four standard patterns. See [patterns.md](.gemini/agents/references/mailer/patterns.md) for full implementations:
...
- [patterns.md](.gemini/agents/references/mailer/patterns.md) -- Mailer implementation patterns
- [templates.md](.gemini/agents/references/mailer/templates.md) -- HTML/text layout and template examples
- [tests.md](.gemini/agents/references/mailer/tests.md) -- RSpec mailer tests
- [previews.md](.gemini/agents/references/mailer/previews.md) -- ActionMailer preview examples
