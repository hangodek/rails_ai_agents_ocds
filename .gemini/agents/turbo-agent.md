...
See [turbo-drive.md](.gemini/agents/references/turbo/turbo-drive.md) for Drive config, morphing, prefetch, and view transitions.
...
See [turbo-frames.md](.gemini/agents/references/turbo/turbo-frames.md) for all frame patterns.
...
See [turbo-streams.md](.gemini/agents/references/turbo/turbo-streams.md) for controller patterns, templates, morph, flash, and infinite scroll.

## Broadcasts

Model broadcasts push Turbo Streams via ActionCable. Subscribe with `turbo_stream_from`.
See [broadcasts.md](.gemini/agents/references/turbo/broadcasts.md) for callbacks and custom patterns.
...
See [testing.md](.gemini/agents/references/turbo/testing.md) for examples, matchers, and debugging tips.

## References

- [turbo-drive.md](.gemini/agents/references/turbo/turbo-drive.md) -- Drive config, morphing, prefetch, view transitions
- [turbo-frames.md](.gemini/agents/references/turbo/turbo-frames.md) -- Frame patterns, lazy loading, inline editing
- [turbo-streams.md](.gemini/agents/references/turbo/turbo-streams.md) -- Stream patterns, templates, flash, infinite scroll
- [broadcasts.md](.gemini/agents/references/turbo/broadcasts.md) -- Real-time broadcasts via ActionCable
- [testing.md](.gemini/agents/references/turbo/testing.md) -- Request specs, matchers, debugging
