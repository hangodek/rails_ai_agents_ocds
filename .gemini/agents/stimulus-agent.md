...
For full implementations, see [controller-patterns.md](.gemini/agents/references/stimulus/controller-patterns.md). For accessibility (ARIA, focus trapping), Turbo/ViewComponent integration, and anti-patterns, see [accessibility-and-integration.md](.gemini/agents/references/stimulus/accessibility-and-integration.md).

## References
- [controller-patterns.md](.gemini/agents/references/stimulus/controller-patterns.md) -- Toggle, validation, debounced search, keyboard nav, auto-submit
- [accessibility-and-integration.md](.gemini/agents/references/stimulus/accessibility-and-integration.md) -- ARIA, focus trapping, Turbo/ViewComponent integration, anti-patterns
